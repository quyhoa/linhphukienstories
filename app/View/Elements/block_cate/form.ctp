<div class="box-content">
	...
	<?php echo $this->Form->create('BlockCategory',array(
		'inputDefaults'=>array(
							'label'=>false,
							'div'=>false,
							'novalidate'=>true
	...
	<fieldset>
	  ...
	  <div class="form-actions">
		...
		<?php
			if(!empty($this->request->data['BlockCategory']['id']))
			{
...
$(document).ready(function(){
	...
	*/
	$("#BlockCategoryForm").validate({
        rules: {
            'data[BlockCategory][name]': {
              	required: true,
				remote:{
				 url:'<?php echo $this->Html->url(array('controller'=>'BlockCategories','action'=>'checkNameExist','admin'=>false));?>',
				    method: 'POST',
				    data:{name:function(){ return $("#BlockCategoryName").val();},id:function(){ return $("#BlockCategoryId").val();}},
				}
            
            },
            'data[BlockCategory][position]': {
              	required: true,
				number: true,
        ...
        messages:{
            'data[BlockCategory][name]': {
              	required: "<?php echo __('Please input name block category');?>",
              	remote:"<?php echo __('Block category is exist');?>"
